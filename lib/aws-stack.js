...
class IamStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const invokeRolePolicyDocument = new iam.PolicyDocument();
    invokeRolePolicyDocument.addStatements(
...
class TackleboxStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    // Lambda Setups
    const setupDbLambda = new lambda.Function(this, "setupDb", {
      runtime: lambda.Runtime.NODEJS_14_X,
      handler: "index.handler",
      code: lambda.Code.fromAsset("./lambdas/setupDb"),
    ...
    new cdk.CfnOutput(this, "setupDbLambda", {
      value: setupDbLambda.functionArn,
      description: "ARN for DB Setup lambda",
      exportName: "setupDbLambda",
    });
  }
}
